...
dstHoG=reshape(pdist2(dscImgHoG,dscPXYHoG,'cityblock'),sizImg(1),sizImg(2));



dstMapHoG=2-reshape(dstHoG,size(img,1),size(img,2));
...
subplot(2,3,2  ), imshow(dstMapHoG,[]),   title('dst-map: HoG');
